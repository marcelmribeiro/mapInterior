...
var mbSatUrl =
  "https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWFyY2VsbXJpYmVpcm8iLCJhIjoiY2xoZzZ0a2JyMjIzNDNycGI3dmNoODZheSJ9.eYWrINl2fCEUZI3Zv8gbsQ";
var mbDarkUrl =
  "https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWFyY2VsbXJpYmVpcm8iLCJhIjoiY2xoZzZ0a2JyMjIzNDNycGI3dmNoODZheSJ9.eYWrINl2fCEUZI3Zv8gbsQ";
var satellite = L.tileLayer(mbSatUrl, {
  id: "mapbox/satellite-v9",
  tileSize: 512,
  zoomOffset: -1,
  attribution: mbAttr,
});
var dark = L.tileLayer(mbDarkUrl, {
  id: "mapbox/dark-v11",
  tileSize: 512,
  zoomOffset: -1,
  attribution: mbAttr,
...
function onEachFeature(f, fl) {
  ...
  let groupFeatBy = f.geometry.type === "Polygon" ? f.properties.une_sgl_un : "";
  ...
  if (lg === undefined) {
    ...
    if (groupFeatBy !== "") {
      layerControl.addOverlay(mapFeatGroups[groupFeatBy], groupFeatBy, {
        sortLayers: true,
        hideSingleBase: true,
        collapsed: false,
      });
  ...
  switch (f.geometry.type) {
    case "Point":
      if (f.properties.hasIdoam) {
        ...
        return il === 1
          ? "#e8e516" //Pressao BAIXA = AMARELO
          : il === 2
            ? "#ff3500" //Pressao ALTA = VERMELHO
        ...
        return stsComm === 0
          ? "#0bd102" //Comunicação Normal = VERDE
